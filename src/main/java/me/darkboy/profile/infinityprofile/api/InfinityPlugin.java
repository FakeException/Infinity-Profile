...
package me.darkboy.profile.infinityprofile.api;
...
import me.darkboy.profile.infinityprofile.api.resource.DefaultResourceProvider;
import me.darkboy.profile.infinityprofile.api.resource.ResourceProvider;
import me.darkboy.profile.infinityprofile.api.resource.json.JsonResourceHandler;
import me.darkboy.profile.infinityprofile.api.resource.yml.YamlResourceHandler;
import me.darkboy.profile.infinityprofile.api.util.logging.ConsoleLog;
import me.darkboy.profile.infinityprofile.api.util.logging.StaticLog;
import me.darkboy.profile.infinityprofile.api.util.reflect.Reflection;
...
public class InfinityPlugin extends JavaPlugin {
    ...
    public final void onLoad() {
        ...
        console.setFormat("[&3" + (description.getPrefix() != null ? description.getPrefix() : description.getName())
                + "&r] [{cheatdestroyer_log_level}]: {cheatdestroyer_log_message}");
