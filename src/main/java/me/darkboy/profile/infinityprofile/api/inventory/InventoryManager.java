...
import me.darkboy.profile.infinityprofile.api.inventory.opener.ChestInventoryOpener;
import me.darkboy.profile.infinityprofile.api.inventory.opener.InventoryOpener;
import me.darkboy.profile.infinityprofile.api.inventory.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    private Map<Player, InfinityInventory> inventories;
    ...
    public List<Player> getOpenedPlayers(InfinityInventory inv) {
    ...
    public Optional<InfinityInventory> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p));
    }

    protected void setInventory(Player p, InfinityInventory inv) {
        if(inv == null)
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if(e.getClickedInventory() == p.getOpenInventory().getTopInventory()) {
                ...
                InfinityInventory inv = inventories.get(p);
